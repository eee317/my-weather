  ...
  stepperpanel: {
    ...
    number: ({ context }) => ({
      class: [
        ...
        // Colors (Conditional)
        // context.active ? 'bg-primary-700 text-surface-0' : 'dark:border-surface-700 text-primary-500 dark:text-surface-0', // Adjust colors as needed
        context.active ? 'bg-primary-700 text-surface-0 font-semibold' : 'bg-primary-200 text-primary-700 font-semibold', // Adjust colors as needed
        ...
        // Borders
        context.active ? 'border-solid border-4 border-primary-200' : 'border-0 border-none',
        // 'border-solid border-4 border-primary-300',
    ...
    title: ({ context }) => ({
      class: [
        ...
        // Text
        context.active ? 'text-primary-700 dark:text-surface-0' : 'text-primary-400 dark:text-surface-0/80',
        'font-bold',
    ...
    separator: ({ context, state, parent }) => ({
      class: [
        ...
        state.d_activeStep <= context.index ? 'bg-primary-200 dark:bg-surface-700' : 'bg-primary-700',
