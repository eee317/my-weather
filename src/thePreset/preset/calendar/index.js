...
export default {
    ...
    input: ({ props }) => ({
        class: [
            ...
            // Colors
            !props.disabled ? [fg.text.normal, fg.bg.normal] : [fg.text.disabled, fg.bg.disabled],
            fg.placeholder,
            ...
            // States
            fg.focus(!(props.disabled || props.readonly)),
            !(props.disabled || props.readonly || props.invalid) && fg.hover,
            { 'cursor-default': props.disabled || props.readonly },
    ...
    groupcontainer: ({ props }) => ({
        class: [
            {
                'flex': props.view !== 'month',
                'hidden': props.view === 'month',
            }
        ]
    }),
    group: {
