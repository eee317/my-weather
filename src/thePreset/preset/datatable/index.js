  ...
  column: {
    headercell: ({ context, props }) => ({
      class: [
        ...
        // Color
        'bg-primary-100 text-primary-700 dark:bg-primary-dark-500',
        'border-surface-200 dark:border-[#393E46] border-t-0',
  ...
  paginator: {
    root: {
      class: [
        ...
        'text-primary-400 dark:text-surface-100',
      ],
    },
    ...
    pagebutton: ({ context }) => ({
      class: [
        ...
        // Color
        {
          'text-white bg-primary-400': context.active,
          'text-primary-400 bg-primary-50': !context.active
        },
        // State
        {
          'hover:bg-primary-400 hover:text-surface-0': !context.disabled,
